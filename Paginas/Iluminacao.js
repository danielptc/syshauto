...
export default class Iluminacao extends React.Component {
    ...
    fSala(){
        ...
        this.setState({sala: this.state.sala = 0})
...
Iluminacao.navigationOptions = {
    title: 'Controle geral de Iluminação',
}
