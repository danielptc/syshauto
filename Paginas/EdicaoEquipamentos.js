...
export default class EdicaoEquipamentos extends React.Component {
        ...
        return (
            ...
            >
                <View style={[styles.card2, { backgroundColor: '#000000' }]}>
                    ...
                    <Fumi
                        style={styles.input}
                        label={`Nome: ${global.nomeEquipamento}`}
                    ...
                    <Fumi
                        style={styles.input}
                        label={`Marca: ${global.marcaEquipamento}`}
                        iconClass={FontAwesomeIcon}
                        iconName={'bolt'}
                        iconColor={'#063e02'}
                    ...
                    <Fumi
                        style={styles.input}
                        label={`Modelo: ${global.modeloEquipamento}`}
                        iconClass={FontAwesomeIcon}
                        iconName={'bolt'}
                        iconColor={'#063e02'}
                    ...
                    <Fumi
                        style={styles.input}
                        label={`Endereço de IP: ${global.enderecoIpEquipamento}`}
                        iconClass={FontAwesomeIcon}
                        iconName={'bolt'}
                        iconColor={'#063e02'}
    ...
    EnviarFormularioEquipamentos = async () => {
        this.setState({
            this: this.id = global.idEquipamento,
        });
    ...
    enviar() {
        const dataToSend = {id: this.id, categoria: this.categoria, nome: this.nome, status: this.status, estado:this.estado,
        ...
        fetch(endereco.enderecoEquipamentos, {
            ...
            Alert.alert("ERRO!",
                "Equipamento não Cadastrado! Tente novamente!");
        });

    }
}

EdicaoEquipamentos.navigationOptions = {
