const data = {
    labels: ['January', 'February', 'March', 'April', 'May', 'June', 'Dezembro'],
    datasets: [{
        data: [
            10,
            20,
        ...
        color: (opacity = 1) => `rgba(200, 240, 20, ${opacity})` // optional
        ...
        color: (opacity = 1) => `rgba(185, 5, 6, ${opacity})` // optional
    },
        {
            data: [
                50,
            ...
            color: (opacity = 1) => `rgba(5, 7, 240, ${opacity})` // optional
        }
    ]
}
...
const pieChartData = [
    ...
    { name: 'China', population: 5960000, color: 'rgb(250,255,7)', legendFontColor: '#7F7F7F', legendFontSize: 15 }
]
